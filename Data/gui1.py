...
class ChatbotGUI:
    ...
    def load_chatbot_data(self):
        ...
        self.intents = json.loads(
            open(
                r"D:\NLP_bot\Data\intents.json").read()
                
        )
        self.words = pickle.load(open(r"D:\NLP_bot\words.pkl", "rb"))
        self.classes = pickle.load(open(r"D:\NLP_bot\classes.pkl", "rb"))
        self.model = load_model(r"D:\NLP_bot\chatbot_model.h5")
